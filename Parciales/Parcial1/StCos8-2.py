...
para  j  en  tolerancia :
    ...
    print ( "La función de actualización en el resultado es:" , '{0: .32g}' . format ( f ( ans [ p ])))
...
ax  =  gl . plot ( kind  =  'bar' , x  =  'Tolerancias' , title =  'Comportamiento respecto a la tolerancia cos ^ 2 (2x) -x ^ 2' , ax  =  ax )
